...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  info: {
    singularName: 'post';
    pluralName: 'posts';
    displayName: 'Noticias y novedades';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiTallerTaller extends Schema.CollectionType {
...
export interface ApiWomensRecordWomensRecord extends Schema.CollectionType {
  collectionName: 'womens_records';
  info: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::womens-record.womens-record': ApiWomensRecordWomensRecord;
    }
  }
}
